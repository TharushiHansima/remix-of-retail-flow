...
export function EditEstimateDialog({ open, onOpenChange, estimate, onSave }: EditEstimateDialogProps) {
  ...
  useEffect(() => {
    if (estimate) {
      setCustomerName(estimate.customer);
      setCustomerPhone(estimate.phone);
      setCustomerEmail(estimate.email || "");
      setDevice(estimate.device);
      setIssue(estimate.issue);
      setStatus(estimate.status);
      setItems(estimate.items || [
        { id: "1", description: "Labor", type: "labor", quantity: 1, unitPrice: estimate.laborCost },
        { id: "2", description: "Parts", type: "parts", quantity: 1, unitPrice: estimate.partsCost },
      ]);
    }
  }, [estimate]);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Edit Estimate - {estimate.estimateNumber}</DialogTitle>
          <DialogDescription>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={status} onValueChange={(value) => setStatus(value as Estimate["status"])}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
